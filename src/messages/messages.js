export const messages = {
    es: {
        "Home.versiculo": "Se oyó un grito, se despertaron y encendieron sus lámparas...",
        "Home.cap": "Mateo 25",
        "Home.title": "UN EVENTO PARA ADORAR A DIOS",
        "Home.content": "Dios nos llamó a levantar un altar de adoración el 18 de diciembre. No es un día de música ni de músicos, es el día de la iglesia para derramar el  corazón en honra a nuestro único amor, Jesús. Te invitamos a unirte a nosotros para este día tan especial. Trae tu mejor adoración, tu corazón.",
        "Home.fecha": "El eventó será realizdo el sabado 18/12",
        "Register.descripcion": "Queremos que todos puedan disfrutar este tiempo con nosotros, por eso la entrada es libre y gratuita. Para poder obtenerla solo debes llenar el siguiente formulario y descargar el código QR. Te recordamos que la iglesia tiene capacidad límitada, por lo que te recomendamos sacar tu entrada lo antes posible para asegurarte tu lugar.",
        ...
        "Error.titulo": "¡Lo sentimos, las inscripciones están cerradas!",
        "Error.descripcion" : "Ya no disponemos de capacidad dentro de la iglesia. "
    }
}